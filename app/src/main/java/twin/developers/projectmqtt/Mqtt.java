...
public class Mqtt {
    ...
    private static final String MQTT_SERVER = "ws://broker.emqx.io:8083/mqtt";
    // Otra opción de servidor MQTT comentada
    //private static final String MQTT_SERVER = "mqtt://[user]:[password]@[address]";

    private static final String CLIENT_ID = "mqttx_ca00cfc2";
    private static final String TOPIC = "EvaluacionNacional/frank";
    ...
    public void disconnect() {
        if (mqttClient != null && mqttClient.isConnected()) {
            try {
                // Intenta desconectar el cliente MQTT
